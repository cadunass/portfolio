...
export const SKILLS: Skill[] = [
  ...
  { name: 'Google Cloud Platform (GCP)', category: 'devops', proficiency: 'advanced' },
  ...
  { name: 'Artificial Intelligence (AI)', category: 'specialized', proficiency: 'advanced' },
  { name: 'Prompt Engineering', category: 'specialized', proficiency: 'advanced' },
  
  // General
  { name: 'Web Development', category: 'general', proficiency: 'expert' },
  { name: 'Full Stack Development', category: 'general', proficiency: 'expert' },
  { name: 'DevOps', category: 'general', proficiency: 'advanced' },
  { name: 'Software Development Life Cycle', category: 'general', proficiency: 'expert' },
];
