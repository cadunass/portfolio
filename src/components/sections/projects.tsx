...
export function Projects({ lang }: ProjectsProps) {
  ...
  const words = [
    {
      text: t.projects.featured,
      className: "text-neutral-800 dark:text-white",
    },
    { text: t.projects.heading, className: "text-neutral-800 dark:text-white" },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          {PROJECTS.map((project) => {
            ...
            const translatedData = t.projectsData[project.id];
            const title = translatedData?.title || project.title;
            const description =
              translatedData?.description || project.description;
